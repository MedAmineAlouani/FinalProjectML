...
md(
    ...
    "≈ 20 hits from each file end up on both sides. Reported for completeness;",
    "the honest comparison is Task 2.*",
    "",
    "### Task 2 — Independent test (LOFO, file-level soft-vote)",
    "",
    "| Model | Accuracy |",
    "|---|---|",
    "| Tuned Random Forest          | 89.58% |",
    "| **Flange-Invariant LR (final)** | **85.42%** |",
    "| CRNN (log-mel)               | 64.58% |",
    "",
    "*The flange-invariant LR trades 4 LOFO points for +38 LOFT points (see §11),",
    "which is the right trade for the actual competition condition (same flange,",
    "new recording session, possibly different torque).*",
    "",
